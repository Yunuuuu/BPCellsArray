...
testthat::test_that("`convert_type` for `BPCellsHDF5Matrix` object works as expected", {
    obj <- BPCellsArray(obj)
...
testthat::test_that("`t()` for `BPCellsHDF5` object works as expected", {
    seed <- BPCellsHDF5Seed(obj)
    testthat::expect_s4_class(seed, "BPCellsHDF5Seed")
    testthat::expect_s4_class(t(seed), "BPCellsHDF5Seed")
    obj <- BPCellsArray(obj)
    testthat::expect_s4_class(t(obj), "BPCellsHDF5Matrix")
})

testthat::test_that("`dimnames<-` for `BPCellsHDF5` object works as expected", {
    seed <- BPCellsHDF5Seed(obj)
    testthat::expect_s4_class(seed, "BPCellsHDF5Seed")
    dimnames(seed) <- list(
...
testthat::test_that("`rownames<-` for `BPCellsHDF5` object works as expected", {
    seed <- BPCellsHDF5Seed(obj)
    testthat::expect_s4_class(seed, "BPCellsHDF5Seed")
...
testthat::test_that("`colnames<-` for `BPCellsHDF5` object works as expected", {
    seed <- BPCellsHDF5Seed(obj)
    testthat::expect_s4_class(seed, "BPCellsHDF5Seed")
...
testthat::test_that("`%*%` for `BPCellsHDF5` object works as expected", {
    seed <- BPCellsHDF5Seed(obj)
    testthat::expect_s4_class(seed, "BPCellsHDF5Seed")
...
testthat::test_that("`rbind` for `BPCellsHDF5` object works as expected", {
    seed <- BPCellsHDF5Seed(obj)
    testthat::expect_s4_class(seed, "BPCellsHDF5Seed")
...
testthat::test_that("`cbind` for `BPCellsHDF5` object works as expected", {
    seed <- BPCellsHDF5Seed(obj)
    testthat::expect_s4_class(seed, "BPCellsHDF5Seed")
...
testthat::test_that("`+` for `BPCellsHDF5Seed` object works as expected", {
    seed <- BPCellsHDF5Seed(obj)
    testthat::expect_s4_class(seed, "BPCellsHDF5Seed")
...
testthat::test_that("`+` for `BPCellsHDF5Matrix` object works as expected", {
    obj <- BPCellsArray(obj)
    testthat::expect_s4_class(obj, "BPCellsHDF5Matrix")
