...
mat2 <- mock_matrix(ncol(mat1), 5000)
...
testthat::test_that("`convert_type` for `BPCellsMultiplySeed` object works as expected", {
    seed <- BPCellsMultiplySeed(obj)
...
testthat::test_that("`rownames<-` for `BPCellsMultiply` object works as expected", {
    seed <- BPCellsMultiplySeed(obj)
    testthat::expect_s4_class(seed, "BPCellsMultiplySeed")
...
testthat::test_that("`colnames<-` for `BPCellsMultiply` object works as expected", {
    seed <- BPCellsMultiplySeed(obj)
    testthat::expect_s4_class(seed, "BPCellsMultiplySeed")
...
testthat::test_that("`+` for `BPCellsMultiplySeed` object works as expected", {
    seed <- BPCellsMultiplySeed(obj)
    testthat::expect_s4_class(seed, "BPCellsMultiplySeed")
