...
testthat::test_that("`rownames<-` for `BPCellsSubset` object works as expected", {
    seed <- BPCellsSubsetSeed(obj)
    testthat::expect_s4_class(seed, "BPCellsSubsetSeed")
...
testthat::test_that("`colnames<-` for `BPCellsSubset` object works as expected", {
    seed <- BPCellsSubsetSeed(obj)
    testthat::expect_s4_class(seed, "BPCellsSubsetSeed")
...
testthat::test_that("`+` for `BPCellsSubsetSeed` object works as expected", {
    seed <- BPCellsSubsetSeed(obj)
    testthat::expect_s4_class(seed, "BPCellsSubsetSeed")
